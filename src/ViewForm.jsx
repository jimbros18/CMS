...
import { ClientView, ChargeTableView, AssistanceTableView, PaymentsView, Inclussions, PriceBreakdown, Staff, Lights } from './ViewFormSections';

export default function ViewForm({client_data, onClose}) {
    const { client, inclussions, otherCharges, assistance, payments, staff, lights, returned } = client_data;
    console.log('ViewForm-client: ', client_data);
    ...
    return (
        <div className="viewform-container inline-flex flex-row p-6 gap-6 w-8/12">        
            <div className="flex flex-col border border-gray-300 text-left rounded shadow-lg bg-white p-6 w-[60%]" >
                ...
                <Inclussions xcoffin = {client["coffin"]} inclussions={inclussions}/>
