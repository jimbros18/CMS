...
import { ClientView, ChargeTableView, DSWDView, PaymentsView, Inclusions, PriceBreakdown } from './ViewFormSections';

export default function ViewForm({client_data, onClose}) {
    const { client, inclusions, otherCharges, dswd, payments } = client_data;
