  ...
  return (
   <div className="client-container flex flex-col items-start py-4 px-4 bg-gray-50 mt-4 rounded">
        <div className='btn_container'>
            <button className="add_client text-white bg-blue-500 hover:bg-blue-700 py-2 px-6 rounded" onClick={() => setNewForm(prev => !prev)}>
                {NewForm ? <X className="hover:bg-red-700" size={16} /> : <Plus size={16} />}
            </button>
        </div>
